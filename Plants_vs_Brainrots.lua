...
local languageScripts = {
    ["English"] = function()
        ...
        AutoTurnInToggle:SetDesc("Auto Event")
        AutoResetRequestToggle:SetTitle("Auto Reset Prison")
        AutoResetRequestToggle:SetDesc("Auto Reset Prison")
        HideNotificationsToggle:SetTitle("Hide Notifications")
        HideNotificationsToggle:SetDesc("Hide Notify")
        LowGraphicsToggle:SetTitle("Low Graphics")
        LowGraphicsToggle:SetDesc("Reduce graphics to increase FPS")
