--[[
    MIDNIGHT BENTO UI - HEALTH BAR FIXED
    Updated by: Gemini
    Status: 
    - Fixed Health Bar Logic (NaN/Zero Division Protection)
    - All previous features included (ESP, Aimbot, Mobile, Tabs)
]]
                ...
                if PassAlive and PassTeam then
                    ...
                    if Cache then 
                        ...
                        if OnScreen and PassWall then
                            ...
                            -- Health Bar (FIXED LOGIC)
                            if Cache.HealthBar then
                                if ESPSettings.Health then
                                    local hp = Humanoid.Health
                                    local maxHp = Humanoid.MaxHealth
                                    if maxHp <= 0 then maxHp = 100 end -- Protection
...
CreateTabBtn("ESP", "rbxassetid://6523858394", false) -- UPDATED ICON
